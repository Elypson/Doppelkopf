...
namespace Doppelkopf.Services
{
    public class UserPermissionService : IUserPermissionService
    {
        ...
        public bool IsMessageFromTokenizedUser(List<ClientConnectionController> clientConnectionControllers, ClientMessage message) => clientConnectionControllers.Exists(controller => controller.Token == message.Token && controller.Initialized);
